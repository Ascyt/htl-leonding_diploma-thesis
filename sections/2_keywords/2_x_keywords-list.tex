...
The format of the version is intended to be functional for the rules of \textit{Semantic Versioning}, where the three integers represent the major, minor and patch version of the component respectively:
...
Where:
\begin{itemize}
    \item \textbf{<os>} is the label of the operating system that is being checked, for example \textit{WIN10}.
\end{itemize}
