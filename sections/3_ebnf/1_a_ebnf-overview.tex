...
Therefore, Extended BNF was later developed from BNF and included the most common extensions. The large amount of variants motivated the standardization effort that resulted in ISO/IEC~14977 \cite[p.~V]{ISO/IEC149771996InformationBNF}.
...
\begin{itemize}
    ...
    Example: A list of one or more identifiers separated by commas: \texttt{<ident\_list> $\rightarrow$ <identifier> \{, <identifier>\}}. \\
...
In this notation, brackets, braces, and parentheses serve as metasymbols (notational tools) rather than terminal symbols of the language being described \cite[pp.~149-151]{SebestaConceptsEdition}.
