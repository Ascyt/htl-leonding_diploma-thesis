...
In this part, we explain our own implementation for the Script Assembler in detail. Aside from \textit{Syntax Highlighting}, everything was written in the \textit{Python} programming language.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \verb|parser_exception.py|: Here, two custom exceptions related to the parser can be found: \verb|ParserSyntaxError| and \verb|ParserInternalError|. They are explained in Chapter~\ref{chap:exceptions-and-warnings}.
    \end{itemize}
