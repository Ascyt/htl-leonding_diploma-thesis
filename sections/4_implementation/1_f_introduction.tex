...
In the \gls{trp} project, the following files and directories make up the core of the Script Assembler and its components, where the \verb|.| directory refers to the project's root:
\begin{itemize}
