...
The formatter keeps track of the current state of the parsing using an internal property that is of type \verb|FormatterInternal| which is defined as the following:
...
TODO: flowchart of parser

\section{Option/Modifier Format}

\section{Parser Exceptions}

\section{TRP Integration}
