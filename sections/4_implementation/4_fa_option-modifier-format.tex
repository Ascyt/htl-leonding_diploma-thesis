...
A syntax exception will be thrown if it defined inside \verb|@BRACKETSTART|, \verb|@BRACKETEND| or another instance of \verb|PREAMBLE|.
...
A syntax exception will be thrown if it is defined \verb|@BRACKETSTART|, \verb|@BRACKETEND| or \verb|@PREAMBLE|.
