\documentclass[12pt,a4paper,twoside,open=right,titlepage,listof=totoc,bibliography=totoc,chapteratlists=0pt]{scrreprt}
...
\chapter{Exceptions and Logging [F]}\label{chap:exceptions-and-warnings}
\setauthor{Filip Schauer}
