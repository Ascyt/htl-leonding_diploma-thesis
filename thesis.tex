...
\chapter{Introduction [F, A, X]}\label{chap:implementation-introduction}
\setauthor{Filip Schauer, Adam Höllerl, Axel Csomany}
\input{./sections/4_implementation/1_fax_introduction.tex}
...
\setauthor{Filip Schauer}
\input{./sections/4_implementation/4_f_option-modifier-format.tex}
