...
\setauthor{Filip Schauer}
\input{./sections/4_implementation/1_f_introduction.tex}

\chapter{Preprocessor [A]}\label{chap:preprocessor}
\setauthor{Adam Höllerl}
\input{./sections/4_implementation/2_a_preprocessor.tex}

\chapter{Parser [F]}\label{chap:parser}
\setauthor{Filip Schauer}
\input{./sections/4_implementation/3_f_parser.tex}

\chapter{Option/Modifier Format [F, A]}\label{chap:option-modifier-format}
\setauthor{Filip Schauer, Adam Höllerl}
\input{./sections/4_implementation/4_fa_option-modifier-format.tex}

\chapter{Exceptions and Logging [F]}\label{chap:exceptions-and-warnigs}
\setauthor{Filip Schauer}
\input{./sections/4_implementation/5_f_exceptions-and-logging.tex}

\chapter{TRP-Integration [X]}\label{chap:trip-integration}
\setauthor{Axel Csomany}
\input{./sections/4_implementation/6_x_trp_integration.tex}

\chapter{Syntax Highlighting [A]}\label{chap:syntax-highlighting}
\setauthor{Adam Höllerl}
\input{./sections/4_implementation/7_a_syntax-highlighting.tex}

\chapter{Extensibility [F]}\label{chap:extensibility}
\setauthor{Filip Schauer}
\input{./sections/4_implementation/8_f_extensibility.tex}

\chapter{Database [X]}\label{chap:database}
\setauthor{Axel Csomany}
\input{./sections/4_implementation/9_x_database.tex}
